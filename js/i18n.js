...
(function () {
  ...
  var EN = {
    ...
    why3_d: 'Every unit passes cold-run and hot-run dyno testing, leak-down and compression checks. Full inspection report shipped with each engine.',
    ...
    desc_reman: 'Fully remanufactured to OE specification. Complete assembly, 100% hot-run dyno-tested with inspection report.',
